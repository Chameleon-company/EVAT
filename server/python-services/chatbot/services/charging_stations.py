...
from chatbot.services.csv_backup import get_csv_backup_stations, save_new_api_stations_to_csv
...
def get_charging_stations(
    ...
    try:
        ...
        from chatbot.services.opencharge import get_opencharge_stations
