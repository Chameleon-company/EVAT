...
DATA_CONFIG = {
    'CHARGER_CSV_PATH': 'data/charger_info_mel.csv',
    'COORDINATES_CSV_PATH': 'data/Co-ordinates.csv',
    'ML_DATASET_PATH': 'data/ml_ev_charging_dataset.csv',
