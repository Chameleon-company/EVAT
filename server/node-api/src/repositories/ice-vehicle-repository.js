...
const ice_vehicle_model_1 = __importDefault(require("../models/ice-vehicle-model"));
class IceVehicleRepository {
    ...
    findById(vehicleId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield ice_vehicle_model_1.default.findById(vehicleId).exec();
        });
    }
    /**
    ...
    findAll() {
        return __awaiter(this, arguments, void 0, function* (filter = {}) {
            return yield ice_vehicle_model_1.default.find(filter).exec();
        });
    }
    /**
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const doc = new ice_vehicle_model_1.default({
                make: data.make,
                model: data.model,
                year: data.year,
    ...
    update(vehicleId, data) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield ice_vehicle_model_1.default.findByIdAndUpdate(vehicleId, Object.assign(Object.assign(Object.assign({}, (data.make !== undefined ? { make: data.make } : {})), (data.model !== undefined ? { model: data.model } : {})), (data.year !== undefined ? { year: data.year } : {})), { new: true, runValidators: true }).exec();
        });
    }
}
exports.default = new IceVehicleRepository();
