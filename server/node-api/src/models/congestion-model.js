...
const CongestionSchema = new mongoose_1.Schema({
    chargerId: {
...
const Congestion = mongoose_1.default.model("Congestion", CongestionSchema, "congestion");
exports.default = Congestion;
