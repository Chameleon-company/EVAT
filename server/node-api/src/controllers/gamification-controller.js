...
class GamificationController {
    ...
    getGameProfileForUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const userProfile = yield game_model_1.GameProfile.findOne({ main_app_user_id: userId })
    ...
    getLeaderboard(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const topUsers = yield game_model_1.GameProfile.find()
     ...
     */
    getVirtualItems(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const items = yield game_model_1.GameVirtualItem.find({ cost_points: { $ne: null } }).exec();
    ...
    purchaseVirtualItem(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!userId)
                return res.status(401).json({ message: "User not authenticated." });
            try {
                const item = yield game_model_1.GameVirtualItem.findOne({ item_id_string: itemId }).exec();
                let userProfile = yield game_model_1.GameProfile.findOne({ main_app_user_id: userId }).exec();
                if (!item)
                    return res.status(404).json({ message: `Item with ID '${itemId}' not found.` });
                if (!userProfile)
                    userProfile = new game_model_1.GameProfile({ main_app_user_id: userId });
                if (item.cost_points === null)
                    return res.status(400).json({ message: "This item cannot be purchased." });
                if (userProfile.inventory.virtual_items.includes(item._id))
                ...
                const eventLog = new game_model_1.GameEvent({
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (userProfile.contribution_summary && summaryKey in userProfile.contribution_summary) {
                    userProfile.contribution_summary[summaryKey]++;
                }
    ...
    createEvent(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const newEvent = new game_model_1.GameEvent(req.body);
                yield newEvent.save();
    ...
    getAllEvents(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const events = yield game_model_1.GameEvent.find().sort({ timestamp: -1 }).limit(200).exec();
    ...
    getEventsByUserId(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const events = yield game_model_1.GameEvent.find({ user_id: req.params.userId }).sort({ timestamp: -1 }).exec();
    ...
    deleteEvent(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const deletedEvent = yield game_model_1.GameEvent.findByIdAndDelete(req.params.eventId).exec();
                if (!deletedEvent) {
    ...
    createGameProfile(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const existingProfile = yield game_model_1.GameProfile.findOne({ main_app_user_id }).exec();
                if (existingProfile) {
                    return res.status(400).json({ message: "A game profile for this user already exists." });
                }
                const newProfile = new game_model_1.GameProfile(req.body);
    ...
    getAllGameProfiles(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const profiles = yield game_model_1.GameProfile.find().exec();
    ...
    getGameProfileByUserId(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const profile = yield game_model_1.GameProfile.findOne({ main_app_user_id: req.params.userId }).exec();
                if (!profile) {
    ...
    updateGameProfile(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const updatedProfile = yield game_model_1.GameProfile.findOneAndUpdate({ main_app_user_id: req.params.userId }, req.body, { new: true }).exec();
                if (!updatedProfile) {
                    return res.status(404).json({ message: "Game profile not found for this user ID" });
                }
    ...
    deleteGameProfile(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const deletedProfile = yield game_model_1.GameProfile.findOneAndDelete({ main_app_user_id: req.params.userId }).exec();
                if (!deletedProfile) {
                    return res.status(404).json({ message: "Game profile not found for this user ID" });
                }
    ...
    createVirtualItem(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const newItem = new game_model_1.GameVirtualItem(req.body);
                yield newItem.save();
    ...
    getAllVirtualItems(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const items = yield game_model_1.GameVirtualItem.find().exec();
    ...
    getVirtualItemById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { itemId } = req.params;
                const item = yield game_model_1.GameVirtualItem.findById(itemId).exec();
                if (!item) {
    ...
    updateVirtualItem(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { itemId } = req.params;
                const updatedItem = yield game_model_1.GameVirtualItem.findByIdAndUpdate(itemId, req.body, { new: true }).exec();
                if (!updatedItem) {
                    return res.status(404).json({ message: "Virtual item not found" });
                }
    ...
    deleteVirtualItem(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { itemId } = req.params;
                const deletedItem = yield game_model_1.GameVirtualItem.findByIdAndDelete(itemId).exec();
                if (!deletedItem) {
                    return res.status(404).json({ message: "Virtual item not found" });
                }
    ...
    createBadge(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const newBadge = new game_model_1.GameBadge(req.body);
                yield newBadge.save();
    ...
    getAllBadges(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const badges = yield game_model_1.GameBadge.find().exec();
    ...
    getBadgeById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const badge = yield game_model_1.GameBadge.findById(badgeId).exec();
                if (!badge) {
    ...
    updateBadge(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { badgeId } = req.params;
                const updatedBadge = yield game_model_1.GameBadge.findByIdAndUpdate(badgeId, req.body, { new: true }).exec();
                if (!updatedBadge) {
                    return res.status(404).json({ message: "Badge not found" });
                }
    ...
    deleteBadge(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { badgeId } = req.params;
                const deletedBadge = yield game_model_1.GameBadge.findByIdAndDelete(badgeId).exec();
                if (!deletedBadge) {
                    return res.status(404).json({ message: "Badge not found" });
                }
    ...
    createQuest(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const newQuest = new game_model_1.GameQuest(req.body);
                yield newQuest.save();
    ...
    getAllQuests(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const quests = yield game_model_1.GameQuest.find().exec();
    ...
    getQuestById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const quest = yield game_model_1.GameQuest.findById(questId).exec();
                if (!quest) {
    ...
    updateQuest(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { questId } = req.params;
                const updatedQuest = yield game_model_1.GameQuest.findByIdAndUpdate(questId, req.body, { new: true }).exec();
                if (!updatedQuest) {
                    return res.status(404).json({ message: "Quest not found" });
                }
    ...
    deleteQuest(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { questId } = req.params;
                const deletedQuest = yield game_model_1.GameQuest.findByIdAndDelete(questId).exec();
                if (!deletedQuest) {
                    return res.status(404).json({ message: "Quest not found" });
                }
...
exports.default = GamificationController;
