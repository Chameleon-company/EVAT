...
import ReliabilityScoringController from "../controllers/reliability-scoring-controller";

const router = Router();

const reliabilityScoringService = new ReliabilityScoringService();
const reliabilityScoringController = new ReliabilityScoringController(
 ...
 */
router.get("/suburbs", authGuard(["user", "admin"]), (req, res) => {
 ...
 */
router.get("/summary", authGuard(["user", "admin"]), (req, res) => {
 ...
 */
router.get("/stations", authGuard(["user", "admin"]), (req, res) => {
 ...
 */
router.get("/stations/:id", authGuard(["user", "admin"]), (req, res) => {
 ...
 */
router.get("/top", authGuard(["user", "admin"]), (req, res) => {
 ...
 *         description: Python service unreachable
 */
router.post("/score", authGuard(["user", "admin"]), (req, res) => {
 ...
 */
router.post("/score/batch", authGuard(["user", "admin"]), (req, res) => {
 ...
 */
router.post("/sentiment", authGuard(["user", "admin"]), (req, res) => {
