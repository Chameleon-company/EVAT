...
const charger_session_controller_1 = __importDefault(require("../controllers/charger-session-controller"));
const charger_session_service_1 = __importDefault(require("../services/charger-session-service"));
const user_stats_service_1 = __importDefault(require("../services/user-stats-service"));
const charger_session_repository_1 = __importDefault(require("../repositories/charger-session-repository"));
// Middleware
const auth_middleware_1 = require("../middlewares/auth-middleware");
// Initialise router
const router = express_1.default.Router();
// Setup: controller -> service -> repository
const chargerSessionRepository = new charger_session_repository_1.default();
const chargerSessionService = new charger_session_service_1.default(chargerSessionRepository);
const chargerSessionController = new charger_session_controller_1.default(chargerSessionService, user_stats_service_1.default);
 ...
 */
router.get('/:sessionId', (0, auth_middleware_1.authGuard)(['user', 'admin']), (req, res) => chargerSessionController.getSessionById(req, res));
/**
 * @swagger
 ...
 */
router.get('/user/:userId', (0, auth_middleware_1.authGuard)(['user', 'admin']), (req, res) => chargerSessionController.getSessionsByUser(req, res));
/**
 * @swagger
 ...
 *         description: Server error
 */
router.get('/station/:stationId', (0, auth_middleware_1.authGuard)(['user', 'admin']), (req, res) => chargerSessionController.getSessionsByStation(req, res));
/**
 * @swagger
 ...
 *         description: Server error
 */
router.post('/', (0, auth_middleware_1.authGuard)(['user', 'admin']), (req, res) => chargerSessionController.createSession(req, res));
/**
 * @swagger
 ...
 */
router.patch('/end/:sessionId', (0, auth_middleware_1.authGuard)(['user', 'admin']), (req, res) => chargerSessionController.endSession(req, res));
/**
 * @swagger
 ...
 */
router.get('/sessions/stream', (0, auth_middleware_1.authGuard)(['admin']), (req, res) => chargerSessionController.streamSessions(req, res));
/**
 * @swagger
 ...
 */
router.get('/sessions/logs', (0, auth_middleware_1.authGuard)(['admin']), (req, res) => chargerSessionController.getLogs(req, res));
