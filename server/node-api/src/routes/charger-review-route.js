...
const charger_review_controller_1 = __importDefault(require("../controllers/charger-review-controller"));
const charger_review_service_1 = __importDefault(require("../services/charger-review-service"));
// Middleware
const auth_middleware_1 = require("../middlewares/auth-middleware");
// Initialise router
const router = express_1.default.Router();
const chargerReviewService = new charger_review_service_1.default();
const chargerReviewController = new charger_review_controller_1.default(chargerReviewService);
/**
 * @swagger
 * components:
 *   schemas:
 ...
 */
router.post("/", (0, auth_middleware_1.authGuard)(["user", "admin"]), (req, res) => chargerReviewController.submitReview(req, res));
/**
 * @swagger
 ...
 */
router.put("/:id", (0, auth_middleware_1.authGuard)(["user", "admin"]), (req, res) => chargerReviewController.updateReview(req, res));
/**
 * @swagger
 * /api/charger-reviews/{id}:
 *   delete:
 ...
 *         description: Review not found
 */
router.delete("/:id", (0, auth_middleware_1.authGuard)(["user", "admin"]), (req, res) => chargerReviewController.deleteReview(req, res));
/**
 * @swagger
 ...
 *         description: Server error
 */
router.get("/charger/:chargerId/user-status", (0, auth_middleware_1.authGuard)(["user", "admin"]), (req, res) => chargerReviewController.checkUserReviewStatus(req, res));
/**
 * @swagger
 ...
 *         description: Server error
 */
router.get("/admin/all", (0, auth_middleware_1.authGuard)(["admin"]), (req, res) => chargerReviewController.getAllReviews(req, res));
