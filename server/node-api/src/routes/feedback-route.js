 ...
 */
router.get("/", (0, auth_middleware_1.authGuard)(["admin"]), (req, res) => feedbackController.getAllFeedbacks(req, res));
/**
 * @swagger
 ...
 *         description: Server error
 */
router.get("/statistics", (0, auth_middleware_1.authGuard)(["admin"]), (req, res) => feedbackController.getFeedbackStatistics(req, res));
/**
 * @swagger
 * /api/feedback/email:
 *   get:
 ...
 *         description: Server error
 */
router.get("/email", (0, auth_middleware_1.authGuard)(["admin"]), (req, res) => feedbackController.getFeedbacksByEmail(req, res));
/**
 * @swagger
 * /api/feedback/{id}:
 *   get:
 ...
 *         description: Server error
 */
router.get("/:id", (0, auth_middleware_1.authGuard)(["admin"]), (req, res) => feedbackController.getFeedbackById(req, res));
/**
 * @swagger
 ...
 *         description: Server error
 */
router.put("/:id/status", (0, auth_middleware_1.authGuard)(["admin"]), (req, res) => feedbackController.updateFeedbackStatus(req, res));
/**
 * @swagger
 * /api/feedback/{id}:
 *   delete:
 ...
 *         description: Server error
 */
router.delete("/:id", (0, auth_middleware_1.authGuard)(["admin"]), (req, res) => feedbackController.deleteFeedback(req, res));
