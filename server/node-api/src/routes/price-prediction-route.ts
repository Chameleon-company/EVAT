...
const pricePredictionController = new PricePredictionController(pricePredictionService);
 ...
 */
router.get("/price/schema", authGuard(["user", "admin"]), (req, res) => {
 ...
 */
router.get("/price/model/info", authGuard(["user", "admin"]), (req, res) => {
 ...
 */
router.post("/price", authGuard(["user", "admin"]), (req, res) => {
 ...
 *         description: Model or schema not loaded
 */
router.post("/price/batch", authGuard(["user", "admin"]), (req, res) => {
