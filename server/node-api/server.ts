...
import PricePredictionRoutes from "./src/routes/price-prediction-route";
import ReliabilityScoringRoutes from "./src/routes/reliability-scoring-route";
...
app.use("/api/predict", PricePredictionRoutes);
app.use("/api/reliability", ReliabilityScoringRoutes);
